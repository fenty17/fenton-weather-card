 ...
 */class ot extends b{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{const s=i?.renderBefore??e;let n=s._$litPart$;if(void 0===n){const t=i?.renderBefore??null;s._$litPart$=n=new Q(e.insertBefore(O(),t),t,void 0,i??{})}return n._$AI(t),n})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return I}}ot._$litElement$=!0,ot.finalized=!0,nt.litElementHydrateSupport?.({LitElement:ot});const rt=nt.litElementPolyfillSupport;rt?.({LitElement:ot}),(nt.litElementVersions??=[]).push("4.2.1");customElements.define("fenton-weather-card-editor",class extends ot{static get properties(){return{hass:Object,config:Object}}setConfig(t){this.config=t||{}}get _schema(){return[{name:"weather_entity",selector:{entity:{domain:"weather"}}},{name:"feels_like_entity",selector:{entity:{domain:"sensor"}}},{name:"precipitation_entity",selector:{entity:{domain:"sensor"}}},{name:"wind_speed_entity",selector:{entity:{domain:"sensor"}}},{name:"wind_gust_entity",selector:{entity:{domain:"sensor"}}},{name:"wind_direction_entity",selector:{entity:{domain:"sensor"}}},{name:"static_icons",selector:{boolean:{}}},{name:"warning_sensor",selector:{entity:{}}},{name:"warning_action_path",selector:{text:{}}}]}_valueChanged(t){this.config=t.detail.value,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this.config}}))}render(){return this.hass?W`
      ...
      ></ha-form>
    `:W``}}),window.customCards=window.customCards||[],window.customCards.push({type:"fenton-weather-card",name:"Fenton Weather Card",description:"Customizable compact weather card"});customElements.define("fenton-weather-card",class extends ot{static get properties(){return{hass:Object,config:Object}}static get styles(){return o`
      :host {
        display: block;
        border-radius: 8px;
        overflow: hidden;
